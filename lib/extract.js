...
function Extract(opts) {
  ...
  me.on("entry", function (entry) {
    ...
    // CVE-2018-20834 fix: Remove hardlinks before fstream processes File entries
    // Use process.nextTick to ensure removal happens after current synchronous code
    // but before fstream's async processing calls _stat()
    if (entry.type === "File") {
